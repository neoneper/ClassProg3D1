...
public class BufferedImageOperationKernel {
    ...
    //Suavisação
    public static final float[][] Kernel_BoxBlur = {{1.0f / 9.0f, 1.0f / 9.0f, 1.0f / 9.0f}, {1.0f / 9.0f, 1.0f / 9.0f, 1.0f / 9.0f}, {1.0f / 9.0f, 1.0f / 9.0f, 1.0f / 9.0f},};
    ...
    public static final float Kernel_Prewitty[][] = {{1, 0, 1}, {1, 0, 1}, {1, 0, 1}};
    //Nitides
